...
class Test_Amenity(unittest.TestCase):
    ...
    def setUp(self):
        """Set up env before each test case"""
    ...
    def test_to_dict_type(self):
        """verify the class returns a dictionary"""
        am = Amenity()
        self.assertTrue(dict, type(am.to_dict()))

    def test_different_to_dict(self):
        """tests to that class produces 2 diff dict for diff instances"""
        am1 = Amenity()
        sleep(0.05)
        am2 = Amenity()
    ...
    def test_to_dict_has_correct_keys(self):
        """test to the dict contains the right keys"""
        am = Amenity()
    ...
    def test_to_dict_created_at_format(self):
        """check the ISO formatted string"""
